...
class ButtonEntry():
    ...
    def get_patient_report(self):
        ...
        patid_label2 = tk.Label(root, text=str(self.patientid_var))
        canvas_main.create_window(300, 600, window=patid_label2)

        self.doa_var = self.doa_entry.get()
        doa_label2 = tk.Label(root, text=str(self.doa_var))
        canvas_main.create_window(300, 640, window=doa_label2)
        ...
        call(['python', 'patientdischargerv2.0beta2.py'])
        return
